...
function QrCode({ value, className }: { value: string; className?: string }) {
  ...
  return (
    <svg
      ...
      role="img"
      aria-label="QR code for this trip link"
    >
      ...
      <DialogContent className="sm:max-w-sm">
        ...
        <div className="flex justify-center">
          <div className="rounded-2xl bg-white p-3">
            <QrCode value={url} className="size-48" />
          </div>
        </div>
        ...
        {anonymous && (
          <p className="flex gap-2 text-xs text-muted-foreground">
            ...
            <span>
              Anyone with this link can open and edit the trip — there is no password on
              it. Sign in and claim the trip if you would rather choose who gets in.
            </span>
          </p>
        )}
      </DialogContent>
