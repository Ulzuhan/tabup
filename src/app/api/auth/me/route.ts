...
import { ocrMode } from "@/lib/receipts";
...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    // Una capacidad de la instancia, no de la cuenta: si leer un ticket está apagado,
    // corre aquí, o manda la foto fuera. Lo pregunta el botón para poder decir lo que
    // hace antes de que alguien lo pulse, no después.
    ocr: ocrMode(),
    usage: {
